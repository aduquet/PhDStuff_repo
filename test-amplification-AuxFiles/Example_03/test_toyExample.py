...
class TestToyExample(unittest.TestCase):
    ...
    def test_get_average(self):
        # create an instance of ToyExample with some data
        toy_example = ToyExample([1, 2, 3, 4, 5])
        
        # perform 4 modifications to the object
        toy_example.remove_duplicates()
        self.track_state(toy_example.data ,testID='test_get_average',methodCall='remove_duplicates', name=name)

        toy_example.multiply_by_scalar(2)
        self.track_state(toy_example.data ,testID='test_get_average',methodCall='multiply_by_scalar', name=name)

        toy_example.append_data(6)
        self.track_state(toy_example.data ,testID='test_get_average',methodCall='append_data', name=name)

        toy_example.reverse_data()
        self.track_state(toy_example.data ,testID='test_get_average',methodCall='reverse_data', name=name)

        
        # test the get_average method
        self.assertEqual(toy_example.get_average(), 7.0)
